...
export const leadGenPDF = async ({ username, magnetIdeas }) => {
    return new Promise ((resolve, reject) => {
        ...
        // Register fonts
        try {
            doc.registerFont('Bold', './fonts/Montserrat-Bold.otf');
            doc.registerFont('Regular', './fonts/Montserrat-Regular.otf');
            doc.registerFont('Medium', './fonts/Montserrat-Medium.otf');
        } catch (error) {
